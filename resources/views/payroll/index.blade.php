...
@section('content')
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400 mt-1">Manage teacher salaries and payroll processing</p>
        </div>
        <div class="flex gap-2">
            <a href="{{ route('payroll.salary-structure') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition">
                Salary Structure
            </a>
            <a href="{{ route('payroll.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
                Process Payroll
            </a>
        </div>
    </div>
