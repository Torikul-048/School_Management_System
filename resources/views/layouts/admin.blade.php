            ...
            <header class="sticky top-0 z-40 bg-white dark:bg-gray-800 shadow-sm">
                <div class="flex items-center justify-between h-16 px-6">
                    ...
                    <div class="hidden md:flex flex-1 max-w-md mx-6">
                        <form action="{{ route('search') }}" method="GET" class="relative w-full" onsubmit="if(!this.q.value.trim()) return false;">
                            <input type="text" name="q" placeholder="Search students, teachers, classes..." 
                                   class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <button type="submit" class="absolute inset-y-0 left-0 flex items-center pl-3 bg-transparent border-0 cursor-pointer">
