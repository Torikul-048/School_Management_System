...
<div class="container mx-auto px-4 py-6 max-w-2xl">
    <h1 class="text-2xl font-bold text-gray-800 dark:text-white mb-6">Create Assignment</h1>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        <form action="{{ route('teacher.assignments.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mt-6 flex gap-3">
                <button type="submit" class="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg">Create Assignment</button>
                <a href="{{ route('teacher.assignments') }}" class="px-6 py-2 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg">Cancel</a>
            </div>
        </form>
    </div>
</div>
